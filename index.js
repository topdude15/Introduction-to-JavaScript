...
function hungryDog(weight, age){
   if (age >= 1) {
     ...
     if (0.16 < age && age < 0.33) {
       return ((weight / 100) * 10);
     } else if (0.33 < age && age <= 0.583) {
       return ((weight / 100) * 5);
     } else if (0.583 < age && age <= 1) {
       return ((weight / 100) * 4);
     }
   }
  }
...
var compPlay = playOptions[random];
...
var results = game('scissors', compPlay);
console.log(results);
